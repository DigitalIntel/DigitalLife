...
export const remotePlayer_entity = (() => {
  ...
  class NPCController extends entity.Component {
    ...
    _LoadModels() {
      ...
      loader.load('xbot.fbx', (fbx) => {
        this._target = fbx;
        this._target.scale.setScalar(0.050);
        ...
        loader.load('WaveHipHopDance.fbx', (a) => { _OnLoad('attack', a); });
        loader.load('WaveHipHopDance.fbx', (a) => { _OnLoad('death', a); });
      });
    }
