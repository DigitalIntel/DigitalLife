...
export const wisdomBotJs = (() => {
    ...
    class CharacterFSM extends finite_state_machine.FiniteStateMachine {
        ...
        _Init() {
            ...
            this._AddState('sadIdle', player_state.SadIdleState);
            this._AddState('walk', player_state.WalkState);
            this._AddState('run', player_state.RunState);
            this._AddState('attack', player_state.AttackState);
            this._AddState('death', player_state.DeathState);
            this._AddState('falling', player_state.FallingState);
            this._AddState('sadWalk', player_state.SadWalkState);
            this._AddState('clapping', player_state.ClappingState);
            this._AddState('dance', player_state.DancingState);
        ...
        _LoadModels() {
            ...
            loader.load('ybot.fbx', (fbx) => {
                ...
                this._manager.onLoad = () => {
                    this._stateMachine.SetState('sadIdle');
                };
                ...
                loader.load('StrutWalking.fbx', (a) => { _OnLoad('walk', a); });
                loader.load('falling.fbx', (a) => { _OnLoad('falling', a); });
                loader.load('WaveHipHopDance.fbx', (a) => { _OnLoad('dance', a); });
                loader.load('Sad Idle.fbx', (a) => { _OnLoad('sadIdle', a); });
                loader.load('Sad Walk.fbx', (a) => { _OnLoad('sadWalk', a); });
                loader.load('Sword And Shield Death.fbx', (a) => { _OnLoad('death', a); });
                loader.load('Clapping.fbx', (a) => { _OnLoad('clapping', a); });
